        ...
        return (
            <React.Fragment>
                ...
                <div className="container my-5">
                    ...
                    <div className="row">
                        {
                            error? <h1 className="mt-5 mx-auto text-center text-danger">{error}</h1>: recipes.map(recipe => {
                                return (
                                <Recipe key={recipe.id} recipe={recipe} handleDetails={() => handleDetails(0, recipe.id)} />
                                )
                            })
                        }
